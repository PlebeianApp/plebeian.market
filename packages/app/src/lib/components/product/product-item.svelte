...
<Card.Root
	class="relative rounded-md flex flex-col border border-black hover:border-secondary transition-colors shadow-xl hover:shadow-2xl duration-200 text-black overflow-hidden"
>
	<a
