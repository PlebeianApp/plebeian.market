...
<Alert.Root class="bg-[var(--neo-blue)]">
	<Alert.Description
		>Your products are published to these relays (servers). You cannot modify this setting for now. Please let us know if you’d like to add
		a relay.</Alert.Description
	>
</Alert.Root>
