...
<div class="pb-4 space-y-6 px-2 w-full">
	{#if !$privatePaymentsQuery?.data?.length}
		<Alert.Root variant="destructive">
			<Alert.Description>
				It seems you don't have any defined payment details. Please go to <a class="underline" href="account/payments">Payments</a> and establish
				at least one.
			</Alert.Description>
		</Alert.Root>
	{:else}
	...
	<div class="flex gap-2">
		<Button variant="primary" class="w-full font-bold" on:click={() => (newRecipientFormVisible = true)}>Add recipient</Button>
