const CURRENCIES = [
  ...
  // Uruguayan Peso
  "VEF",
  // Venezuelan Bolivar (note: highly volatile and subject to frequent changes)
  "PHP",
  // Philippine Peso
  "THB",
  // Thai Baht
...
const META_NAMES = Object.fromEntries([
...
const USER_TRUST_LEVEL = {
  TRUST: "trust",
  REASONABLE: "reasonable",
  PARANOID: "paranoid"
};
const PAYMENT_DETAILS_METHOD = {
  LIGHTNING_NETWORK: "ln",
  ON_CHAIN: "on-chain",
  CASHU: "cashu",
  OTHER: "other"
};
const PRODUCT_IMAGES_TYPE = {
  GALLERY: "gallery",
  THUMBNAIL: "thumbnail"
};
const PRODUCT_TYPES = {
...
export {
  ...
  META_NAMES as M,
  ORDER_STATUS as O,
  PAYMENT_DETAILS_METHOD as P,
  USER_ROLES as U,
  USER_META as a,
  META_SCOPES as b,
  META_DATA_TYPES as c,
  PRODUCT_TYPES as d,
  PRODUCT_IMAGES_TYPE as e,
  PRODUCT_META as f,
  CURRENCIES as g,
  USER_TRUST_LEVEL as h
};
