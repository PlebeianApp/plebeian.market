...
export const metaTypes = sqliteTable("meta_types", {
  name: text("name", {
    enum: Object.values(META_NAMES) as NonEmptyArray<MetaName>,
  }).primaryKey(),
  description: text("description"),
  scope: text("scope", {
    enum: Object.values(META_SCOPES) as NonEmptyArray<MetaScopes>,
  }).notNull(),
  dataType: text("data_type", {
    enum: Object.values(META_DATA_TYPES) as NonEmptyArray<MetaDataTypes>,
  }).notNull(),
});
...
export const appSettingsMeta = sqliteTable("app_meta", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => createId()),
  appId: text("app_id").references(() => appSettings.instancePk, {
    onDelete: "cascade",
    onUpdate: "cascade",
  }),
  metaName: text("meta_name")
...
export const paymentDetails = sqliteTable("payment_details", {
  ...
  paymentMethod: text("payment_method", {
    enum: Object.values(
      PAYMENT_DETAILS_METHOD,
    ) as NonEmptyArray<PaymentDetailsMethod>,
  }).notNull(),
...
export const shippingZoneRelations = relations(shippingZones, ({ one }) => ({
  shipping: one(shipping, {
    fields: [shippingZones.shippingId, shippingZones.shippingUserId],
    references: [shipping.id, shipping.userId],
  }),
}));
...
export const products = sqliteTable("products", {
  ...
  productType: text("product_type", {
    enum: Object.values(PRODUCT_TYPES) as NonEmptyArray<ProductTypes>,
  })
    .notNull()
    .default("simple"),
...
export const productImages = sqliteTable(
  "product_images",
  {
    ...
    imageType: text("image_type", {
      enum: Object.values(
        PRODUCT_IMAGES_TYPE,
      ) as NonEmptyArray<ProductImagesType>,
    })
      .notNull()
      .default("gallery"),
  ...
  (table) => {
    return {
      pk: primaryKey({
        columns: [table.productId, table.auctionId, table.imageUrl],
      }),
    };
  },
);
...
export const auctions = sqliteTable("auctions", {
  ...
  status: text("status", {
    enum: Object.values(AUCTION_STATUS) as NonEmptyArray<AuctionStatus>,
  }).notNull(),
...
export const bids = sqliteTable("bids", {
  ...
  bidStatus: text("bid_status", {
    enum: Object.values(BID_STATUS) as NonEmptyArray<BidStatus>,
  })
    .notNull()
    .default("pending"),
});
...
export const orders = sqliteTable("orders", {
  ...
  status: text("status", {
    enum: Object.values(ORDER_STATUS) as NonEmptyArray<OrderStatus>,
  })
    .notNull()
    .default("pending"),
  shippingId: text("shipping_id").references(() => shipping.id, {
    onDelete: "set null",
  }),
  stallId: text("stall_id")
    .notNull()
...
export const invoices = sqliteTable("invoices", {
  ...
  type: text("type", {
    enum: Object.values(INVOICE_TYPE) as NonEmptyArray<InvoiceType>,
  }).notNull(),
  invoiceStatus: text("invoice_status", {
    enum: Object.values(INVOICE_STATUS) as NonEmptyArray<InvoiceStatus>,
  })
    .notNull()
    .default("pending"),
...
export const appSettings = sqliteTable("app_settings", {
  ...
  isFirstTimeRunning: integer("is_first_time_running", { mode: "boolean" })
    .notNull()
    .default(true),
  ...
  allowRegister: integer("allow_register", { mode: "boolean" })
    .notNull()
    .default(true),
