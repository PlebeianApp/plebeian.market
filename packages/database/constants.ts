...
export const STALL_META: Record<
  string,
  MetaInterface<"is_user_featured" | "is_global_featured">
> = {
  IS_USER_FEATURED: { value: "is_user_featured", dataType: "boolean" },
  IS_GLOBAL_FEATURED: { value: "is_global_featured", dataType: "boolean" },
} as const;
...
export const DIGITAL_PRODUCT_META: Record<
  string,
  MetaInterface<"license_key" | "download_link" | "mime_type" | "sha256_hash">
> = {
...
export const APP_SETTINGS_META: Record<
  string,
  MetaInterface<"blossom_server" | "nip96_server" | "word_blacklist">
> = {
...
export const USER_META: Record<
  string,
  MetaInterface<"trust_lvl" | "role" | "v4v_share" | "wallet_details">
> = {
...
export const PM_NPUB =
  "npub1market6g3zl4mxwx5ugw56hfg0f7dy7jnnw8t380788mvdyrnwuqgep7hd";
